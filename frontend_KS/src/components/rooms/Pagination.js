...
const Pagination = () => {
    ...
    return (
        <div className='flex items-center justify-center gap-2 py-5'>
            ...
            {!isHideEnd && <PageNumber icon={<FontAwesomeIcon icon={faArrowRight}/>} setCurrentPage={setCurrentPage} text={Math.floor(count / posts.length)} />}
        </div>
    )
}
